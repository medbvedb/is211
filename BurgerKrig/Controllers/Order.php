...
class Order {
    ...
    public function sendMail($email) {
        ...
        if (isset($email) && !empty($email)) {
            try {
                $mail->SMTPDebug = 2;
                $mail->CharSet = 'UTF-8';
                $mail->SetFrom("v.milevskiy@coopteh.ru","Misha-Beauty");
                ...
                $mail->Subject = 'Заявка с сайта: Misha-Beauty';
                $mail->Body = 'Информационное сообщение c сайта Misha-Beauty <br><br>
                ------------------------------------------<br>
                <br>
                Спасибо!<br>
                <br>
                Ваш заказ успешно создан и передан администратору, ожидайте звонка для уточнения деталей.<br>
                <br>
    ...
    public function get(): string
    {
        ...
        $all_sum = 0;
        $str_list = '<h1>Бронирование</h1><br><br>';
    ...
    public function create(): string {
        ...
        $_SESSION['flash'] = 'Ваш заказ успешно создан и передан администратору, ожидайте звонка для уточнения деталей';
        header('Location: /');
        return '';
